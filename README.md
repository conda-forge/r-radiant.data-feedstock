About r-radiant.data-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-radiant.data-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-radiant.data-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-radiant.data
# for installing globally
pixi global install r-radiant.data
```
...
It is possible to list all of the versions of `r-radiant.data` available on your platform:
...
```
pixi search r-radiant.data --channel conda-forge
```
